...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)// Serve para capturar quando esquece de passar algum parametro...
    ...
    @ExceptionHandler(Exception.class)// para capturar erros geral não tratados por outras classes...
    ...
    @ExceptionHandler(DataIntegrityViolationException.class)// Criar um usuário com o mesmo user name cai neste filtro...
    ...
    @ExceptionHandler(ConstraintViolationException.class)// Usuário sem senha corrigir...
